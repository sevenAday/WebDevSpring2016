...
module.exports = function (passport, app, db, mongoose) {
    ...
    var documentService = require("./services/document.service.server.js")(app, documentModel, commentModel, projectUserModel);
    var userService = require("./services/user.service.server.js")(passport, app, projectUserModel, documentModel);
};